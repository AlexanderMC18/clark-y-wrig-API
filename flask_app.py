...
# Define las variables coord, pedidos, almacen y max_carga aquí
coord = {
...
almacen = (40.23, -3.40)
max_carga = 0  # Asigna un valor predeterminado, puedes modificarlo según sea necesario
...
def resultado():
    try:
        global max_carga  # Declarar max_carga como una variable global
        ...
        # Imprime la excepción para obtener más información sobre el error
        print("Error:", str(e))
